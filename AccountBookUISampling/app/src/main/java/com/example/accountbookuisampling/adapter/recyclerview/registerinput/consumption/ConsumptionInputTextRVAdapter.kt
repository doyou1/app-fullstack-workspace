package com.example.accountbookuisampling.adapter.recyclerview.registerinput.consumption
...
class ConsumptionInputTextRVAdapter(
    list: ArrayList<String>,
    private val parentBinding: FragmentConsumptionBinding,
    private val inputFragment: RegisterConsumptionInputTextFragment,
                ...
                if (item == TEXT_ADD) {
                    ...
                    when (flag) {
                        FLAG_ASSET -> {
                            ...
                            if (parentBinding.etCategory.text.toString()
                                    .isEmpty()
                            ) parentBinding.etCategory.requestFocus()
                            else if (parentBinding.etAmount.text.toString()
                                    .isEmpty()
                            ) parentBinding.etAmount.requestFocus()
                            else if (parentBinding.etDetail.text.toString()
                                    .isEmpty()
                            ) parentBinding.etDetail.requestFocus()
                        }
                        FLAG_CATEGORY -> {
                            parentBinding.etCategory.setText(item)
                            if (parentBinding.etAmount.text.toString()
                                    .isEmpty()
                            ) parentBinding.etAmount.requestFocus()
                            else if (parentBinding.etDetail.text.toString()
                                    .isEmpty()
