...
import com.example.accountbookuisampling.adapter.recyclerview.registerinput.transfer.TransferInputTextRVAdapter
...
class RegisterTransferInputTextFragment(
    ...
    private fun setAssetView() {
        ...
        _binding.recyclerView.adapter = TransferInputTextRVAdapter(assetList, parentBinding, this, categoryFlag)
    }
    ...
    private fun setCategoryView() {
        ...
        // set recycler view
        _binding.recyclerView.layoutManager = getLayoutManager(INPUT_ITEM_VIEW_SPAN_COUNT)
        _binding.recyclerView.adapter = TransferInputTextRVAdapter(categoryList, parentBinding, this, categoryFlag)
    }
