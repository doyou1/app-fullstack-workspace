...
class ConsumptionInputCalculateRVAdapter(
    ...
    private val inputFragment: RegisterConsumptionInputAmountFragment,
    ...
    inner class CalculateInputViewHolder(private val binding: RvItemCalculateInputBinding) :
        ...
        fun bind(item: String) {
            ...
            binding.btnInput.setOnClickListener {
                val prev = inputBinding.etInput.text.toString()
                ...
                inputBinding.etInput.setText(value)
            }
        }
    }
}