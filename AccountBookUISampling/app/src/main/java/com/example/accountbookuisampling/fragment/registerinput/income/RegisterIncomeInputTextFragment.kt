...
class RegisterIncomeInputTextFragment(
    ...
    private fun setAssetView() {
        ...
        _binding.recyclerView.adapter = IncomeInputTextRVAdapter(assetList, parentBinding, this, categoryFlag)
    }
    ...
    private fun setCategoryView() {
        ...
        // set recycler view
        _binding.recyclerView.layoutManager = getLayoutManager(INPUT_ITEM_VIEW_SPAN_COUNT)
        _binding.recyclerView.adapter = IncomeInputTextRVAdapter(categoryList, parentBinding, this, categoryFlag)
    }
