...
import com.example.accountbookuisampling.registerinput.adapter.consumption.ConsumptionInputDateRVAdapter
...
class RegisterConsumptionInputDateFragment(
    ...
    private fun setDateView() {
        ...
        binding.recyclerView.adapter =
            ConsumptionInputDateRVAdapter(date, list, parentBinding, this)
