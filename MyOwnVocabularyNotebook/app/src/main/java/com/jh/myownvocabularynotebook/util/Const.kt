...
object Const {
    ...
    const val TEXT_URL = "url"
    const val TEXT_FILE_NAME = "fileName"
    const val URL_PRIVACY_POLICY = "https://sites.google.com/view/myownvocabularynotebookprivacy"
    const val URL_TERMS_AND_CONDITIONS =
        "https://sites.google.com/view/myownvocabularynotebooktermsan"
    const val FILE_NAME_PRIVACY_POLICY = "privacy_policy.md"
    const val FILE_NAME_TERMS_AND_CONDITIONS = "terms_and_conditions.md"
